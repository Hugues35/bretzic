                ...
                <?php else: ?>
                    ...
                    <form method="POST" action="./userconnectionsuccess" >
                        ...
                        <div id="inscrip-form-datas">
                            <ul>                        
                                <li>Pseudo<br>
                                <input type="text" name="pseudo" id="pseudo-connect" placeholder="pseudo" required></li>
                                <span id="pseudoHelp"></span>                              
                            
                                <li>Mot de passe<br>
                                <input type="password" name="password" id="pass-connect" placeholder="Ex : ********" required ></li>
