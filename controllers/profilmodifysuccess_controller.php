    ...
    if(isset($_POST['pseudo'])){
        if(!empty($_POST['pseudo'])){
            ...
            if($password != $passwordconfirm){
                ...
                // Envoi emails
                //mail('huguesfleury35133@gmail.com', 'Moficication profil', $message);
                //mail($email, 'Votre profil a bien été modifié sur www.bretzic.com. Merci !', $message);
                ...
                //$validation = 'Bonjour ' . $pseudo .'. Vos informations ont bien été enregistrées. Merci !';
                sleep(1);
                unset($_POST);
            }
